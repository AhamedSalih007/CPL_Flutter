...
class UIDimensions {
  ...
  static EdgeInsetsGeometry symmetricPaddingInsets({
    double vertical = 0.0,
  ...
  static EdgeInsetsGeometry onlyPaddingInsets({
    double left = 0.0,
    double top = 0.0,
    double right = 0.0,
    double bottom = 0.0,
  ...
  static EdgeInsetsGeometry lTRBPaddingInsets(
    double left,
    double top,
    double right,
    double bottom,
  ...
  static EdgeInsetsGeometry allPaddingInsets(double val) =>
      REdgeInsets.all(val);
